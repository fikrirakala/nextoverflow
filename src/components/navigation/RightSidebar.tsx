...
export default function RightSidebar() {
  return (
    <section className="sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l bg-background p-6 pt-36 shadow dark:shadow-none max-xl:hidden">
      <div>
